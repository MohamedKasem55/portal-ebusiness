...
@Injectable()
export class RequestReactivateStopService {
  servicesUrl: string
  ...
  public validate(batch): Observable<any> {
    ...
    return this.http
      .post(this.servicesUrl + '/chequeBook/requestStatus/stop/validate', data)
      .pipe(
        map((response: any) => {
          const body = response
  ...
  public save(batch, requestValidate): Observable<any> {
    ...
    return this.http
      .post(this.servicesUrl + '/chequeBook/requestStatus/stop/confirm', data)
      .pipe(
        map((response: any) => {
          const body = response
          if (response.errorCode !== '0') {
  ...
  public delete(batch): Observable<any> {
    ...
    return this.http
      .delete(this.servicesUrl + '/chequeBook/requestStatus/stop/delete', {
        params: _param,
      })
      .pipe(
        map((response: any) => {
