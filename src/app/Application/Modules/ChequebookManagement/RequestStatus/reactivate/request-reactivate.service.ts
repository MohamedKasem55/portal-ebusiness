...
export class RequestReactivateService {
  ...
  public validate(batch): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/chequeBook/requestStatus/create/validate',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public save(batch, requestValidate): Observable<any> {
    ...
    return this.http
      .post(this.servicesUrl + '/chequeBook/requestStatus/create/confirm', data)
      .pipe(
        map((response: any) => {
          const body = response
          if (response.errorCode !== '0') {
  ...
  public delete(batch): Observable<any> {
    ...
    return this.http
      .delete(this.servicesUrl + '/chequeBook/requestStatus/create/delete', {
        params: _param,
      })
      .pipe(
        map((response: any) => {
