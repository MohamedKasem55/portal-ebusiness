...
import { PayrollAgreementListService } from './payroll-agreement-list.service'
import {saveAs} from "file-saver";

@Component({
  selector: 'app-payroll-agreement-list',
  templateUrl: './payroll-agreement-list.component.html',
  styleUrls: ['./payroll-agreement-list.component.scss'],
})
export class PyrollAgreementListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    public listService: PayrollAgreementListService,
  ) {
