...
@Injectable()
export class LockboxUsersEditService extends AbstractActionModifyService {
  editData: any = {}
  ...
  public configureEditFormModel(detailsData) {
    ...
    _fieldsConfigForForm.push({
      ...
      translate: 'passwordModify',
      type: 'password',
      required: false,
      default: detailsData.passwordModify,
      validators: [],
      widget_container_class: 'col-xs-12 col-sm-3',
      widget_container_init_row: false,
      widget_container_end_row: false,
  ...
  protected createInitRequest(values: any): Observable<any> {
    ...
    return this.http
      .post(this.servicesUrl + '/lockbox/userManagement/modify/init', params)
      .pipe(
        map((result: any) => {
  ...
  public getSelectedItemEditData() {
  ...
  protected createConfirmRequest(values: any): Observable<any> {
    ...
    return this.http.post(
      this.config.getServicesUrl() + '/lockbox/userManagement/modify/confirm',
      params,
    )
  }
