...
@Injectable()
export class LockboxUsersChangeStatusService extends AbstractActionModifyService {
  action = ''
  ...
  public configureSuspendFormModel(detailsData) {
    ...
    /*
        return this.http
            .post(
                ...
                '/lockbox/userManagement/changeStatus/init',
                params,
            )
            .pipe(
                map((response) => {
  ...
  protected createConfirmRequest(values: any): Observable<any> {
    ...
    return this.http.post(
      this.config.getServicesUrl() +
        '/lockbox/userManagement/changeStatus/confirm',
      params,
    )
  }
