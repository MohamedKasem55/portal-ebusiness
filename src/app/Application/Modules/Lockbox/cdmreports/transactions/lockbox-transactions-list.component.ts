...
import { LockboxTransactionsListService } from './lockbox-transactions-list.service'
import { TranslateService } from '@ngx-translate/core'
import { AuthenticationService } from '../../../../../core/security/authentication.service'
import { StaticService } from '../../../Common/Services/static.service'

@Component({
  selector: 'app-lockbox-transactions-list',
  templateUrl: './lockbox-transactions-list.component.html',
  styleUrls: ['./lockbox-transactions-list.component.scss'],
})
export class LockboxTransactionsListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  routes: any[] = [
    ...
    ['lockbox.cdmReports.transactions'],
  ]
  ...
  constructor(
    ...
    public listService: LockboxTransactionsListService,
  ) {
  ...
  onClickRow(row: any, propName = null) {
    // this.router.navigate(['/lockbox/transactions/details'])
  }
