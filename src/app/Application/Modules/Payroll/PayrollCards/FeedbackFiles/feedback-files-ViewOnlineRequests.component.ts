...
@Component({
  ...
  templateUrl: './feedback-files-ViewOnlineRequests.component.html',
})
export class FeedbackFilesViewOnlineRequestComponent
  extends DatatableMobileComponent
  implements OnInit, OnDestroy
{
  @ViewChild('onlineRequestTable', { static: true }) table: any
  ...
  constructor(
    ...
    this.onlineRequest = new PagedData<any>()
  ...
  setPage(dataTableEvent) {
    ...
    const data = {
      ...
      rows: this.onlineRequest.page.pageSize,
    }

    // Service Call
    this.subscription = this.service
      .onlineRequest(data, this.search)
      .subscribe((result) => {
        if (result === null) {
          //this.onError(result);
          //
        } else {
          this.onlineRequest.data = result.fileDTOList
          ...
          this.onlineRequest.page = pageObject
