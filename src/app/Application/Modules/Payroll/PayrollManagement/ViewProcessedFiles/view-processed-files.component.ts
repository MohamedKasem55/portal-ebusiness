    ...
    if (data.type == 'X') {
      ...
      this.viewProcessedFiles
        ...
        .subscribe((result) => {
          ...
          this.viewProcessedFiles.setCurrenItem(this.viewFileDetails)
      ...
      this.viewProcessedFiles
        ...
        .subscribe((result) => {
          if (result === null) {
            ...
            this.step = 'detail'
            if (result['salaryFileDetails']['salaryDetailsDTOList']) {
              for (
                let i = 0;
                result['salaryFileDetails']['salaryDetailsDTOList'].length > i;
                i++
              ) {
                result['salaryFileDetails']['salaryDetailsDTOList'][i][
                  'employeeNumber'
                ] = this.pad(
                  result['salaryFileDetails']['salaryDetailsDTOList'][i][
                    'employeeNumber'
