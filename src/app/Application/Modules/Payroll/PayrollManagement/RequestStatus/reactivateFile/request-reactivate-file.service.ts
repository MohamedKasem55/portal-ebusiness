...
export class RequestReactivateFileService {
  ...
  public reIinistSalaryPayment(batch): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/payrollStandard/requestStatus/reInitiateFile',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public saveSalaryPayments(batch, requestValidate): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/payrollStandard/requestStatus/saveReInitiateFile',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public deleteSalaryPayments(batch): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/payrollStandard/requestStatus/saveDeleteFile',
        data,
      )
      .pipe(
        map((response: any) => {
