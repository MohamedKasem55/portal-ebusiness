...
import { BillPaymentsBatch } from './processed-transactions.model'
...
export class ProcessedTransactionsComponent
    ...
    routes: any[] = [['dashboard.payments'], ['payments.bill-payments', ['/payments/billPayments']], ['menu.sadad.bill_payments.processed_Transactions']]
    ...
    constructor(
        ...
        public processTransactionsBillService: ProcessedTransactionsBillService
    ) {
    ...
    onClickRow(row: BillPaymentsBatch, propName = null) {
        this.processTransactionsBillService.setSelectedItem(row);
        this.router.navigate(['/payments/billPayments/processedTransactions/details'])
    }
