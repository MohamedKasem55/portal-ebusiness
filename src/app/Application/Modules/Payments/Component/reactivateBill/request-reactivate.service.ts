...
@Injectable()
export class RequestBillReactivateBillService {
  servicesUrl: string
  ...
  public reIinitiate(batch): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/billPaymentService/requestStatus/billAdd/validate',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public save(batch, requestValidate): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/billPaymentService/requestStatus/billAdd/confirm',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public delete(batch): Observable<any> {
    ...
    return this.http
      .delete(
        this.servicesUrl + '/billPaymentService/requestStatus/billAdd/delete',
        { params: _param },
      )
      .pipe(
        map((response: any) => {
