...
@Injectable()
export class RequestReactivateFileService {
  servicesUrl: string
  ...
  public reIinistSalaryPayment(batch): Observable<any> {
    ...
    return this.http
      .post(this.servicesUrl + '/payrollWPS/requestStatus/reInitiateFile', data)
      .pipe(
        map((response: any) => {
          const body = response
  ...
  public saveSalaryPayments(batch, requestValidate): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/payrollWPS/requestStatus/saveReInitiateFile',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public deleteSalaryPayments(batch): Observable<any> {
    ...
    return this.http
      .post(this.servicesUrl + '/payrollWPS/requestStatus/saveDeleteFile', data)
      .pipe(
        map((response: any) => {
          const body = response
          if (response.errorCode !== '0') {
