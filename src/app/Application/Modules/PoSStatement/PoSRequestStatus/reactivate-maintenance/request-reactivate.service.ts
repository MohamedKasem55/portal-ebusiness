...
export class RequestReactivateService {
  ...
  public reIinitiate(batch): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl +
          '/posManagement/requestStatus/maintenance/reInitiate',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public save(batch, requestValidate): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl +
          '/posManagement/requestStatus/maintenance/saveReInitiate',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public delete(batch): Observable<any> {
    ...
    return this.http
      .delete(
        this.servicesUrl + '/posManagement/requestStatus/maintenance/delete',
        { params: _param },
      )
      .pipe(
        map((response: any) => {
