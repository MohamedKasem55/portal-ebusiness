  ...
  implements OnInit
{
  ...
  urlActivate = ['/posstatement/pos-request/request-status/activate']
  ...
  setPage(pageInfo) {
    ...
    this.requestStatusSubscription = this.requestStatusService
      ...
      .subscribe((result) => {
        if (!result.error) {
          this.requestStatus.elements = result.posRequestBatchList.items
          this.requestStatus.size = result.posRequestBatchList.size
          this.requestStatus.total = result.posRequestBatchList.total
  ...
  search() {
    this.searchFormData = Object.assign({}, this.searchForm.value)
    //console.log("searchForm:", this.searchForm, this.searchFormData);
    this.requestStatusSubscription = this.requestStatusService
