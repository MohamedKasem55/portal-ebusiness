import { AccountRulesSearchService } from './search/account-rules-search.service';
import {
    Component,
    EventEmitter, Input,
    OnDestroy,
...
export class AccountRulesStep1Component implements OnInit, OnDestroy {
    ...
    @Input() companyPropertiesForm: FormGroup
    messageError = {}
    form: FormGroup
    accounts: any[] = []
    account: any;
    ...
    constructor(
        ...
        public searchService: AccountRulesSearchService,
    ...
    ngOnInit() {
        ...
        this.account = this.getAccountNumberSelected()
        if(this.account){
    ...
    getAccountNumberSelected():string {
        let account = this.searchService.getAccountSelected()
        return account?.fullAccountNumber;
    }
