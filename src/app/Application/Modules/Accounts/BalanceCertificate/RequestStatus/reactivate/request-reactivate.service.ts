...
export class RequestReactivateService {
  ...
  public reInitiate(batch): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/balanceCertificate/requestStatus/validate',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public save(batch, requestValidate): Observable<any> {
    ...
    return this.http
      .post(
        this.servicesUrl + '/balanceCertificate/requestStatus/confirm',
        data,
      )
      .pipe(
        map((response: any) => {
  ...
  public delete(batch): Observable<any> {
    ...
    return this.http
      .delete(this.servicesUrl + '/balanceCertificate/requestStatus/delete', {
        params: _param,
      })
      .pipe(
        map((response: any) => {
  ...
  public init(): Observable<any> {
    return this.http.get(this.servicesUrl + '/balanceCertificate/init').pipe(
      map((response: any) => {
        const body = response
        if (response.errorCode !== '0') {
          const exception: Exception = new Exception(
