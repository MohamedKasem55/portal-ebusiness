...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  getDashboard(fdate: Date, tdate: Date) {
    ...
    this._service
      .getDashboard(body)
      .subscribe((response: ResponseRelatedFilesPayrollWPS) => {
