  ...
  implements OnInit
{
  ...
  copyToSearch() {
    ...
    this.valueDateFromSearch = this.valueDateFrom
    this.valueDateToSearch = this.valueDateTo
  ...
  setPage(dataTableEvent) {
    ...
    this.service
      .getDataTableResults(
        ...
        this.valueDateFromSearch,
        this.valueDateToSearch,
