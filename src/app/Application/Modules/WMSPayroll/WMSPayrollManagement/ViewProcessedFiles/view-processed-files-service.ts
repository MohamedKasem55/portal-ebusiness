...
export class ViewProcessedFilesService {
  ...
  public getDataTableResults(
    ...
    if (
      (amountfrom == null &&
        ...
        fileType == null &&
        initiationDatefrom == null &&
        initiationDateto == null &&
    ...
    return this.http
      .post(this.servicesUrl + '/payrollWPS/processedFile/list', data)
      .pipe(
        map((response: any) => {
          let result: any
          const body = response
  ...
  public getDataTableGetFilesResults(
    page: number,
    rows: number,
    wmsSalaryFileDTOSelected,
    payrollCompanyDetails,
  ): Observable<any> {
    const data = {
      file: wmsSalaryFileDTOSelected,
      payrollCompanyDetails,
      page,
      rows,
    }
  ...
  public getCancelFileDetail(
    ...
    return this.http
      .post(this.servicesUrl + '/payrollWPS/sentFile/viewCancelFiles', data)
      .pipe(
        map((response: any) => {
          if (response.errorCode !== '0') {
            return null
