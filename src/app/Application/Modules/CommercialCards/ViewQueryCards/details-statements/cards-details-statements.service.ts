...
@Injectable()
export class CardsDetailsStatementsService extends AbstractListService {
  constructor(
  ...
  protected createDataRequest(
    ...
    return this.http.post(
      this.servicesUrl + '/businessCards/statement/details',
      params,
    )
  }
  ...
  protected createStatementsListKeysValuesRequest(
    ...
    return this.http.post(
      this.servicesUrl + '/businessCards/statement/list',
      params,
    )
  }
}
