...
@Component({
  templateUrl: './payroll-fees-management.component.html',
  styleUrls: ['payroll-fees-management.component.scss'],
  selector: 'app-payroll-fees-management',
})
export class PayrollFeesManagementComponent
  extends DatatableMobileComponent
  implements OnInit
{
  public payrollFees: PayrollCompanyDetails
  public feesPage: PagedData<GeneralFee> = new PagedData<GeneralFee>()
  public pageSize = 50
  public page = 0
  ...
  private _getPayrollFees(): void {
    this._feesService.getPayRollFees().subscribe((res) => {
