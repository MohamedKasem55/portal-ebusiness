...
@Component({
    selector: 'app-government-revenue-transfer-payments-detail',
    templateUrl: './government-revenue-transfer-payments-detail.component.html',
})
export class GovernmentRevenueTransferPaymentsDetailComponent
    implements OnInit {
    @Input() payment
    @Input() error
