...
@Component({
  selector: 'export-pa-wps-payroll',
  templateUrl: './export-pa-wps-payroll.html',
  providers: [{ provide: 'Window', useValue: window }],
})
export class ExportPaWpsPayrollComponent
  ...
  ngOnInit(): void {
    ...
    this.level_column = [
      { title: this.translate.instant('wpspayroll.level'), dataKey: 'level' },
    ...
    this.employee_column = [
      {
        title: this.translate.instant('wpspayroll.employeeNumber'),
        dataKey: 'employeeReference',
      },
      {
        title: this.translate.instant('wpspayroll.employeeName'),
        dataKey: 'name',
      },
      {
      ...
      {
        title: this.translate.instant('wpspayroll.account'),
        dataKey: 'account',
      },
      { title: this.translate.instant('wpspayroll.salary'), dataKey: 'salary' },
      {
        title: this.translate.instant('wpspayroll.basicSalary'),
        dataKey: 'salaryBasic',
      },
      {
        title: this.translate.instant('wpspayroll.housingAllowance'),
        dataKey: 'allowanceHousing',
      },
      {
        title: this.translate.instant('wpspayroll.otherAllowance'),
        dataKey: 'allowanceOther',
      },
      {
        title: this.translate.instant('wpspayroll.department'),
        dataKey: 'departmentId',
      },
      {
        title: this.translate.instant('wpspayroll.remarks'),
        dataKey: 'remarks',
      },
    ]
  }
  ...
  private getTableDetail(talign) {
    ...
    if (this.currentItem['salaryPaymentItem'] == true) {
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.deductFromAccount'),
            talign,
          ),
      ...
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.customerCIC'),
            talign,
          ),
      ...
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.organizationName'),
            talign,
          ),
      ...
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.paymentDate'),
            talign,
          ),
          this.getDetailText(this.currentItem['valueDate'], talign),
          talign,
        ),
      )
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.batchPayrollName'),
            talign,
          ),
      ...
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.initiationDate'),
            talign,
          ),
      ...
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.fileReference'),
            talign,
          ),
      ...
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.numberOfPayments'),
            talign,
          ),
          this.getDetailText(this.currentItem['numberPayments'], talign),
          talign,
        ),
      )
      result.push(
        this.getLine(
          ...
          this.getDetailText(this.currentItem['totalAmount'], talign),
          talign,
        ),
      )
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.accountFrom'),
            talign,
          ),
          this.getDetailText(this.currentItem['accountFrom'], talign),
          talign,
      ...
      const fileSendDate = new DateFormatPipe(
        this.injector,
        this._locale,
      ).transform(this.currentItem['fileSendDate'], 'dd/MM/yyyy')
      result.push(
        this.getLine(
          this.getDetailTitle(
            this.translate.instant('wpspayroll.fileSendDate'),
            talign,
          ),
