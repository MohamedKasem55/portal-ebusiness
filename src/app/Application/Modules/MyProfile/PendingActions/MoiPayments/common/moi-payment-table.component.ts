...
@Component({
  selector: 'app-moi-payment-table',
  templateUrl: './moi-payment-table.component.html',
})
export class MoiPaymentTableComponent
  ...
  implements OnInit, OnChanges, OnDestroy
{
  ...
  private prepareItems() {
    this.items.forEach((item) => {
      ...
      item.citizenId = this.service.getCitizenIdFromDetails(
  ...
  onCustomInnerSelect({ selected }) {
    ...
    this.service.setPaymentsSelected(this.tableSelectedRows)
  }
