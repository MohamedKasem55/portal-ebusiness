...
import { MOI_PAYMENTS_FORMS_FIELDS_CONFIGS } from '../../../../Payments/MOI/Payment/moi-payment.form-fields-configs'
...
@Component({
  selector: 'app-moi-payment-pa-confirmation-table',
  templateUrl: './moi-payment-pa-confirmation-table.component.html',
})
export class MoiPaymentPaConfirmationTableComponent
