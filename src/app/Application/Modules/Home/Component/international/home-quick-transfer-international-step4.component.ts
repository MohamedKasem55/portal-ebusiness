  ...
  implements OnInit, OnDestroy
{
  ...
  private calculateVat(): void {
    const totalAmount = this.confirmSave.generateChallengeAndOTP
      ? this.confirmSave.totalAmountProcess
      : this.confirmSave.totalAmountAuthorize
    ...
    const vatAmount = totalFees - feesAmount

    this.vat = (vatAmount * 100) / totalAmount
  }
