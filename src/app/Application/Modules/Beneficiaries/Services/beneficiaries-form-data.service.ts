...
@Injectable()
export class BeneficiariesFormData {
  servicesUrl: string
  ...
  public getBankNameIban(idBank: string): Observable<any> {
    // Se contrullen los parametros de entrada
    const entryParam = '{"names": [' + idBank + ']}'
    //console.log("entrada iban bank");
    //console.log(entryParam);

    return this.http
      .get(this.servicesUrl + '/statics/list' + entryParam)
